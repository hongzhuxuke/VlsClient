...
OutputBaseFilename=VhallLiveSetup_{#EXE_VER}_debug
...
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Cored.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Guid.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Networkd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Widgetsd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Multimediad.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5MultimediaWidgetsd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5OpenGLd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Positioningd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5PrintSupportd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Qmld.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Quickd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5QuickWidgetsd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Sensorsd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5Sqld.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5WebChanneld.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5WebKitd.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\bin\Qt5WebKitWidgetsd.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\plugins\bearer\*.*"; DestDir: "{app}\Qtplugins\bearer"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\plugins\imageformats\*.*"; DestDir: "{app}\Qtplugins\imageformats"; Flags: ignoreversion
Source: "C:\Qt\Qt5.4.1\5.4\msvc2013\plugins\platforms\*.*"; DestDir: "{app}\Qtplugins\platforms"; Flags: ignoreversion
