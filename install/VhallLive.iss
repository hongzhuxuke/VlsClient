...
[Dirs]  
Name: "{userdocs}\VhallHelper\vhlog"      
Name: "{userdocs}\VhallHelper\crashDumps"
Name: "{userdocs}\VhallHelper\logs"
Name: "{userdocs}\VhallHelper\pluginData"
Name: "{userdocs}\VhallHelper\profiles"
Name: "{userdocs}\VhallHelper\sceneCollection"
Name: "{userdocs}\VhallHelper\services"
Name: "{userdocs}\VhallHelper\updates"
Name: "{userdocs}\VhallHelper\dshowlog"
[Code]
...
Source: "..\Release\config.ini"; DestDir: "{userdocs}\VhallHelper";BeforeInstall:killprocess('VhallLive.exe');  Flags: onlyifdoesntexist uninsneveruninstall
...
Source: "..\Release\Qt5Sensors.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\Release\Qt5WebKit.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\Qt5WebKitWidgets.dll"; DestDir: "{app}"; Flags: ignoreversion
