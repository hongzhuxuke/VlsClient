...
#define EXE_VER "2.4.9.17"
#define VER_NAME "tencent"
#define fps  25
...
SetupIconFile=vhalltencent.ico
AppName=  {cm:vname}
...
Source: tmpTencent\*; DestDir: {tmp}; Flags: dontcopy solidbreak ; Attribs: hidden system
Source: ".\tmpTencent\botva2.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: ".\tmpTencent\InnoCallback.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\Release\tencent_image\login_logo.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\tencent_image\splash.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\tencent_image\versionBack.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\tencent_image\VhallLiveBG.jpg"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\tencent_image\vhalllogo.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\tencent_image\vhallTitleLogo.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\tencent_image\vhprocessbarback.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\tencent_image\vhall_tool_config.ini";  DestDir: "{userdocs}\VhallHelper"; Flags: ignoreversion
;Source: "..\Release\tencent_image\vhalltencent.ico"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\VhallLive\project\vhalltencent.ico"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\Release\plugins\access\libfilesystem_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libaudio_format_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_output\libamem_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\codec\libavcodec_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\video_chroma\libswscale_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\video_output\libvmem_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libugly_resampler_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\codec\libfaad_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;

Source: "..\Release\plugins\audio_filter\liba52tofloat32_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\liba52tospdif_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libaudio_format_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libdolby_surround_decoder_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libdtstofloat32_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libdtstospdif_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libmpgatofixed32_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libsamplerate_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libscaletempo_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libsimple_channel_mixer_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libtrivial_channel_mixer_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\audio_filter\libugly_resampler_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;


Source: "..\Release\plugins\demux\libh264_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\demux\libmp4_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\demux\libwav_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
  
Source: "..\Release\plugins\demux\libes_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
Source: "..\Release\plugins\codec\libmpeg_audio_plugin.dll"; DestDir: "{app}\plugins\"; Flags: ignoreversion recursesubdirs createallsubdirs;
...
Name: "{group}\{cm:showName}"; Filename: "{app}\VhallLive.exe"; IconFilename:"{app}\vhalltencent.ico"
Name: "{group}\{cm:UninstallProgram,cm:showName}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\{cm:showName}"; Filename: "{app}\VhallLive.exe"; IconFilename:"{app}\vhalltencent.ico"; Tasks: DesktopIcon
