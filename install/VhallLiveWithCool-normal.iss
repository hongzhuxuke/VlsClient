...
;libcef depend
Source: "..\Release\locales\*.*"; DestDir: "{app}\locales"; Flags: ignoreversion
Source: "..\Release\swiftshader\*.*"; DestDir: "{app}\swiftshader"; Flags: ignoreversion
Source: "..\Release\cef.pak"; DestDir: "{app}";  Flags: ignoreversion
Source: "..\Release\cef_100_percent.pak"; DestDir: "{app}";  Flags: ignoreversion
Source: "..\Release\cef_200_percent.pak"; DestDir: "{app}";  Flags: ignoreversion
Source: "..\Release\cef_extensions.pak"; DestDir: "{app}";  Flags: ignoreversion
Source: "..\Release\cefsimple.exe"; DestDir: "{app}";  Flags: ignoreversion
...
Source: "..\Release\devtools_resources.pak"; DestDir: "{app}";  Flags: ignoreversion
...
Source: "..\Release\vh_webview_dll.dll"; DestDir: "{app}";  Flags: ignoreversion
Source: "..\Release\pepflashplayer32_32_0_0_344.dll"; DestDir: "{app}";  Flags: ignoreversion
Source: "..\Release\manifest.json"; DestDir: "{app}";  Flags: ignoreversion
...
Source: "..\Release\freeglut.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\freeglut.dll"; DestDir: "{app}"; Flags: ignoreversion

Source: "..\Release\vmaf_v0.6.1.pkl"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\vmaf_v0.6.1.pkl.model"; DestDir: "{app}"; Flags: ignoreversion

Source: "..\Release\helper_image\login_logo.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\helper_image\splash.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\helper_image\versionBack.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\helper_image\VhallLiveBG.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\helper_image\vhalllogo.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\helper_image\vhallTitleLogo.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\helper_image\vhprocessbarback.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\helper_image\default_pushstream_pic.png"; DestDir: "{app}"; Flags: ignoreversion


Source: "..\Release\helper_image\vhall_tool_config.ini";  DestDir: "{userdocs}\VhallHelper"; Flags: ignoreversion
...
Source: "..\Release\spin.gif"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\Release\VHDesktopCapture.dll"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\WinPCapTool.dll"; DestDir: "{app}"; Flags: ignoreversion
...
Source: "..\Release\libssh2.dll"; DestDir: "{app}"; Flags: ignoreversion
