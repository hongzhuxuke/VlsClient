...
Source: "..\VhallLive\project\vhallhide.ico"; DestDir: "{app}"; Flags: ignoreversion
...
Name: "{group}\{cm:showName}"; Filename: "{app}\VhallLive.exe"; IconFilename:"{app}\vhallhide.ico"
Name: "{group}\{cm:UninstallProgram,cm:showName}"; Filename: "{uninstallexe}"
;Name: "{commondesktop}\微吼直播"; Filename: "{app}\VhallLive.exe"; IconFilename:"{app}\vhallhide.ico"; Tasks: DesktopIcon
Name: "{commondesktop}\{cm:showName}"; Filename: "{app}\VhallLive.exe"; IconFilename:"{app}\vhallhide.ico"; Tasks: DesktopIcon
