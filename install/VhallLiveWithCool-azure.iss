...
#define EXE_VER "2.4.9.9"
#define VER_NAME "azure"
#define fps  25
...
Source: "..\Release\azure_image\login_logo.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\azure_image\splash.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\azure_image\versionBack.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\azure_image\VhallLiveBG.jpg"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\azure_image\vhalllogo.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\azure_image\vhallTitleLogo.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\azure_image\vhprocessbarback.png"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\Release\azure_image\vhall_tool_config.ini";  DestDir: "{userdocs}\VhallHelper"; Flags: ignoreversion
